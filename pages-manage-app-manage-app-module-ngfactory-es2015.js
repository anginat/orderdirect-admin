(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-manage-app-manage-app-module-ngfactory"],{
 ...
 * tslint:disable
 */ 
var styles = ["\n/*# sourceMappingURL=data:application/json;base64, */"];
...
class ManageAppComponent {
    ...
    submit() {
        if (this.haveSave) {
            ...
            this.spinner.show();
            this.api.post('manage/editList', param).then((data) => {
            ...
            if (this.name && this.status) {
                ...
                console.log('param', param);
                this.spinner.show();
                this.api.post('manage/save', param).then((data) => {
                    console.log('data', data);
                    this.spinner.hide();
                    if (data && data.status === 200) {
                        this.success('status updated');
...
//# sourceMappingURL=pages-manage-app-manage-app-module-ngfactory-es2015.js.map