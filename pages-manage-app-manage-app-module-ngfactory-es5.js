  ...
  function srcAppPagesManageAppManageAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var ManageAppComponent = /*#__PURE__*/function () {
      function ManageAppComponent(api, toastyService, spinner, navCtrl) {
      ...
      _createClass(ManageAppComponent, [{
        ...
        value: function submit() {
          ...
          if (this.haveSave) {
            ...
            this.spinner.show();
            this.api.post('manage/editList', param).then(function (data) {
            ...
            if (this.name && this.status) {
              ...
              this.spinner.show();
              this.api.post('manage/save', _param).then(function (data) {
                console.log('data', data);
...
//# sourceMappingURL=pages-manage-app-manage-app-module-ngfactory-es5.js.map